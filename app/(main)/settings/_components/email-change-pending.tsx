...
export function EmailChangePending({
  ...
  return (
    <div className="space-y-4 rounded-lg border border-foreground/10 bg-foreground/5 p-4">
      ...
      <div className="space-y-2 rounded-md bg-foreground/5 p-3 text-sm">
        <p className="font-medium text-foreground">{t("email_change_steps")}</p>
        <ol className="list-inside list-decimal space-y-1 text-foreground/60">
