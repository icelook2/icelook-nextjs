...
import { renameService } from "../_actions";
...
export function RenameServiceDialog({
  service,
  nickname,
  open,
  onOpenChange,
}: RenameServiceDialogProps) {
    ...
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal open={open} size="sm">
        ...
        <Dialog.Footer className="justify-end">
          ...
          <Button type="submit" form="rename-service-form" loading={isPending}>
            {t("save")}
          </Button>
        </Dialog.Footer>
      </Dialog.Portal>
