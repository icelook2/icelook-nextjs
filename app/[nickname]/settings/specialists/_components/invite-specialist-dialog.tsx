...
import { inviteSpecialist } from "../_actions";

interface InviteSpecialistDialogProps {
  beautyPageId: string;
  nickname: string;
}
...
export function InviteSpecialistDialog({
  beautyPageId,
  nickname,
}: InviteSpecialistDialogProps) {
