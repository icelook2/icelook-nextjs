      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted max-w-2xl mx-auto">
              Watch how beauty professionals use Icelook to manage
          ...
          <div className="space-y-24">
              ...
              <Paper className="p-6">
                ...
                <div className="space-y-2">
                  {["Haircut", "Styling", "Makeup"].map((service) => (
                    <div key={service} className="p-3 rounded-lg bg-surface-alt flex justify-between">
                      <span className="text-sm">{service}</span>
                      <span className="text-sm text-accent font-medium">Book →</span>
                    </div>
                  ))}
                </div>
              </Paper>
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <Paper className="p-6 order-2 lg:order-1">
                ...
                <div className="space-y-2">
                  {[
                    { time: "9:00", name: "Anna M.", service: "Haircut", status: "done" },
                    { time: "11:00", name: "Kate S.", service: "Color", status: "now" },
                    { time: "2:00", name: "Maria L.", service: "Styling", status: "next" },
                  ].map((apt) => (
                    <div
                      key={apt.time}
                    ...
                    >
                      ...
                      {apt.status === "done" && <Check className="h-4 w-4 text-success" />}
                      {apt.status === "now" && (
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="mt-4 text-lg text-muted">
                  See all your appointments, manage your schedule, and keep track
                  of your clients — all from one simple dashboard.
                </p>
                <ul className="mt-6 space-y-3">
                  {[
              ...
              <Paper className="p-6">
                ...
                <div className="bg-surface-alt rounded-lg p-4 text-sm">
                  <p className="text-muted">
                    Hi Anna! This is a reminder for your appointment tomorrow at 10:00 AM
                    with Amber Beauty for Haircut & Styling.
                  </p>
        ...
        <section className="border-t border-border bg-gradient-to-b from-accent/5 to-transparent">
          <div className="mx-auto max-w-3xl px-6 py-20 text-center">
            ...
            <Button variant="primary" size="lg" className="mt-8" render={<Link href="/auth" />}>
              Get started free
            </Button>
          </div>
        </section>
