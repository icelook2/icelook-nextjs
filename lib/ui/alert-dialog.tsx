...
function AlertDialogPortal({
  ...
  return (
    <BaseAlertDialog.Portal keepMounted>
      <BaseAlertDialog.Backdrop className="fixed inset-0 bg-black/50 backdrop-blur-[2px]" />
      ...
      >
        <BaseAlertDialog.Popup
          className={cn(
            ...
            "bg-surface",
            "focus:outline-none",
            // Mobile: bottom sheet with top rounded corners, full width
            "rounded-t-2xl px-6 pb-6 pt-2",
            // Desktop: centered with max-width constraint and all corners rounded
