 ...
 * - Working days are prefetched in context (6 months ahead)
 * - Month navigation is instant (no loading)
 * - Time slots are prefetched when a date is clicked
 */
...
export function StepDateSelect({ translations }: StepDateSelectProps) {
  ...
  // Handle date click - select and prefetch time slots
  const handleDateClick = (dateObj: Date) => {
    setSelectedDate(dateObj);
    // Prefetch time slots immediately when date is clicked
    prefetchTimeSlotsForDate(dateObj);
  };
        ...
        <div className="min-h-[280px]">
          ...
          {!isWorkingDaysLoading && (
            <>
              ...
              {/* Days grid - no loading state on month navigation */}
                      ...
                      className={cn(
                        ...
                        item.isSelected
                          ...
                          : [
                              ...
                              // Non-selectable dates - strikethrough
                              !item.isSelectable && "line-through",
                            ],
                      )}
                    >
                      {item.day}
