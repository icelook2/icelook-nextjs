<script lang="ts">
	...
	async function save() {
		...
		try {
			...
			const res = await fetch('/me/contacts/phone-number-2', {
				method: 'PATCH',
...
<header class="flex items-center gap-3">
	<BackButton fallback="/settings/contacts" />
	<h1 class="text-xl font-semibold text-neutral-900 dark:text-neutral-50">Phone 2</h1>
</header>

<div class="mt-6">
	<FormField label="Phone 2" {error}>
