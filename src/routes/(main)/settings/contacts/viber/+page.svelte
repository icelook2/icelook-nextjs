<script lang="ts">
	...
	async function save() {
		...
		try {
			...
			const res = await fetch('/me/contacts/viber', {
				method: 'PATCH',
...
<header class="flex items-center gap-3">
	...
	<h1 class="text-xl font-semibold text-neutral-900 dark:text-neutral-50">Viber</h1>
</header>

<div class="mt-6">
	<FormField label="Viber" {error}>
